...
echo singularity exec docker://broadinstitute/gatk:4.1.3.0 gatk HaplotypeCallerSpark --input ./${1}.dedup.bam --output ${1}_spark.g.vcf --reference $2  -ERC GVCF
singularity exec docker://broadinstitute/gatk:4.1.3.0 gatk HaplotypeCallerSpark --input ./${1}.dedup.bam --output ${1}_spark.g.vcf --reference $2  -ERC GVCF
